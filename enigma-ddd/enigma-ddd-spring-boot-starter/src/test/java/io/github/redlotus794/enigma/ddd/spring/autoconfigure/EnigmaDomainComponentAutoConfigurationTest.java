...
class EnigmaDomainComponentAutoConfigurationTest {
    ...
    @Test
    void testTransactionalEventProxy() {
        final TransactionalEventProxy transactionalEventProxy =
                enigmaDomainComponentAutoConfiguration.transactionalEventProxy();
        assertNotNull(transactionalEventProxy);
        assertSame(DefaultTransactionalEventProxy.INSTANCE, transactionalEventProxy);
    }

    @Test
    void testRealTimeExecutionEventListener() {
        final RealTimeExecutionEventListener listener =
                enigmaDomainComponentAutoConfiguration.realTimeExecutionEventListener(
                        DefaultTransactionalEventProxy.INSTANCE);
