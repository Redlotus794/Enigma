...
class DomainEventPublisherTest {
    ...
    void test_NoPublisherImpl_load_shouldThrowException() throws Exception {
        ...
        try {
            final Enumeration<URL> systemResources = ClassLoader.getSystemResources("META-INF/services/io.github.redlotus794.enigma.ddd.core.event.DomainEventPublisher");
